...
export default function WorkoutTimerBar({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-[calc(env(safe-area-inset-bottom)+0.9rem)] z-40 flex justify-center px-4">
      <div className="pointer-events-auto flex items-center gap-1 rounded-full border border-white/12 bg-[#0B0F16]/92 py-1 pl-1.5 pr-1 shadow-[0_10px_34px_rgba(0,0,0,0.55)] backdrop-blur-xl">
